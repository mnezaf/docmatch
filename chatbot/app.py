...
cuis=[]
morecui=[]
METAMAP=<path to /public_mm/bin/metamap18>
chatstep = 0
...
csp={}
nci={}
f = open("C:/DS/Projects/slack-Docmatch-v2/2019AB/META/MRDEF.RRF",'r', encoding='utf-8')
l = f.readline()
for i in range(10000):
	while (l):
		words = l.strip().split("|")
...
def predictSpecialist(cuilist):
	print(cuilist)
	f = open("C:/DS/Projects/slack-Docmatch-v2/column_name.txt",'r')
	...
	testdf[cuilist]=1
	logisticRegr = pickle.load(open("/C:/DS/Projects/slack-Docmatch-v2/specialist_classifier_logReg_UMLS",'rb'))
...
def findMoreSymptoms(cuilist):
	df = pd.read_csv("C:/DS/Projects/slack-Docmatch-v2/discipline_symptoms_umls2.csv",header=None)
