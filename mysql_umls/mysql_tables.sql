...
load data local infile 'MRXW_CHI.RRF' into table MRXW_CHI fields terminated by '|' ESCAPED BY '' lines terminated by '\n'
(@lat,@wd,@cui,@lui,@sui)
SET LAT = NULLIF(@lat,''),
WD = NULLIF(@wd,''),
CUI = NULLIF(@cui,''),
...
load data local infile 'MRXW_EST.RRF' into table MRXW_EST fields terminated by '|' ESCAPED BY '' lines terminated by '\n'
(@lat,@wd,@cui,@lui,@sui)
SET LAT = NULLIF(@lat,''),
WD = NULLIF(@wd,''),
CUI = NULLIF(@cui,''),
...
load data local infile 'MRXW_GRE.RRF' into table MRXW_GRE fields terminated by '|' ESCAPED BY '' lines terminated by '\n'
(@lat,@wd,@cui,@lui,@sui)
SET LAT = NULLIF(@lat,''),
WD = NULLIF(@wd,''),
CUI = NULLIF(@cui,''),
...
load data local infile 'MRXW_TUR.RRF' into table MRXW_TUR fields terminated by '|' ESCAPED BY '' lines terminated by '\n'
(@lat,@wd,@cui,@lui,@sui)
SET LAT = NULLIF(@lat,''),
WD = NULLIF(@wd,''),
CUI = NULLIF(@cui,''),
